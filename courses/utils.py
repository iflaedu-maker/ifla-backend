...
def generate_certificate_pdf(certificate):
    ...
    if os.path.exists(template_path):
        ...
        langlevel_x, langlevel_y = page_width * 0.45 - 4, page_height * 0.400  # one centered line, moved 4px left
        date_x, date_y = page_width * 0.48 - 8, page_height * 0.350  # bottom-right label area, moved 8px left
